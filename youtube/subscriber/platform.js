...
*/
  ...
  var ta = function(a) {
      if (a instanceof t && a.constructor === t && a.ga === sa) return a.T;
  ...
  var wa = function(a) {
      if (a instanceof v && a.constructor === v && a.fa === va) return a.R;
      na("expected object of type SafeUrl, got '" + a + "' of type " + aa(a));
    ...
    za = function(a) {
      ...
      ma(xa.test(a), "%s does not match the safe URL pattern", a) ||
  ...
  var Ba = function(a) {
      if (a instanceof z && a.constructor === z && a.ea === Aa) return a.F;
      na("expected object of type SafeHtml, got '" + a + "' of type " + aa(a));
      return "type_error:SafeHtml";
    },
    Aa = {};
  z.prototype.D = function(a) {
    var b;
    void 0 === qa && (qa = ja("gapi#html"));
    this.F = (b = qa) ? b.createHTML(a) : a;
    return this;
  };
  var Ca = new z();
  Ca.F =
    m.trustedTypes && m.trustedTypes.emptyHTML ? m.trustedTypes.emptyHTML : "";
  var Da = { MATH: !0, SCRIPT: !0, STYLE: !0, SVG: !0, TEMPLATE: !0 },
    Ea = (function(a) {
      var b = !1,
        c;
      return function() {
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
  ...
  var J = function(a, b, c) {
    ...
    Wa = /%([a-f]|[0-9a-fA-F][a-f])/g,
    Xa = /^(https?|ftp|file|chrome-extension):$/i,
    Ya = function(a) {
      a = String(a);
      a = a
    ...
    ab = function(a, b, c, d) {
      a = Ya(a);
      a.query.push.apply(a.query, $a(b, d));
      a.g.push.apply(a.g, $a(c, d));
      return Za(a);
    },
    bb = new RegExp(
      /\/?\??#?/.source +
    ...
    cb = function(a, b) {
      ...
      b = b instanceof v ? b : za(b);
      a.href = wa(b);
      e.appendChild(a);
      b = e.innerHTML;
      c = new t(ra, "Assignment to self.");
      oa(ta(c), "must provide justification");
      ma(!/^[\s\xa0]*$/.test(ta(c)), "must provide non-empty justification");
      b = new z().D(b);
      if (Da[e.tagName.toUpperCase()])
        throw Error(
          "goog.dom.safe.setInnerHtml cannot be used to set content of " +
            e.tagName +
            "."
        );
      if (Ea()) for (; e.lastChild; ) e.removeChild(e.lastChild);
      e.innerHTML = Ba(b);
  ...
  var tb = function(a, b, c) {
    ...
    N = function(a, b, c) {
      rb[a] = (!b && rb[a]) || c || new Date().getTime();
      tb(a);
    },
    vb = function(a, b, c) {
      b &&
  ...
  var yb = /^(\/[a-zA-Z0-9_\-]+)+$/,
    ...
    Jb = function(a, b, c, d) {
      a = Hb(a);
      Bb.test(c) || O("invalid_callback");
      b = Ib(b);
      d = d && d.length ? Ib(d) : null;
      var e = function(f) {
    ...
    Hb = function(a) {
      ...
      b = "/" + c.join("/");
      yb.test(b) || O("invalid_prefix");
      c = 0;
      for (d = zb.length; c < d; ++c) zb[c].test(b) && O("invalid_prefix");
      c = Kb(a, "k", !0);
      d = Kb(a, "am");
      e = Kb(a, "rs");
      a = Kb(a, "t");
    ...
    Fb = /^https?:\/\/[a-z0-9_.-]+\.google(rs)?\.com(:\d+)?\/[a-zA-Z0-9_.,!=\-\/]+$/,
    Eb = /\/cb=/g,
    Db = /\/\//g,
    Lb = function() {
      var a = lb(Fa.href);
  ...
  var Mb = decodeURI("%73cript"),
    ...
    Sb = function(a) {
      if ("loading" != B.readyState) Qb(a);
      else {
        var b = Pb(),
          c = "";
        null !== b && (c = ' nonce="' + b + '"');
        a = "<" + Mb + ' src="' + encodeURI(a) + '"' + c + "></" + Mb + ">";
        B.write(Rb ? Rb.createHTML(a) : a);
      }
    },
    Qb = function(a) {
      var b = B.createElement(Mb);
      b.setAttribute("src", Rb ? Rb.createScriptURL(a) : a);
      a = Pb();
      null !== a && b.setAttribute("nonce", a);
      b.async = "true";
      (a = B.getElementsByTagName(Mb)[0])
    ...
    Wb = function(a, b, c) {
      ...
      if (y.length) {
        ...
        if (y.length) {
          ...
          h.push.apply(h, y);
          vb("ml0", y, r);
          b.sync || A.___gapisync ? Sb(a) : Qb(a);
        } else G[K](Ga);
      } else u(y) && d && d();
    },
    Rb = ja("gapi#gapi");
  ...
  var Yb = function(a) {
    ...
    cc = function(a) {
      ...
      d = Yb("cd");
      a = 0;
      for (b = d.length; a < b; ++a) P(Zb(), d[a], !0);
      d = Yb("ci");
      a = 0;
      for (b = d.length; a < b; ++a) P(Zb(), d[a], !0);
      a = 0;
      for (b = c.length; a < b; ++a) P(Zb(), c[a], !0);
    },
    Q = function(a) {
      var b = Zb();
      if (!a) return b;
    ...
    ic = function() {
      if (!gc) {
        ...
        if (window.self !== window.top) {
          ...
          for (var e in fc) 0 < fc[e] && (b = J(a, e, "")) && (hc[e] = b);
        }
        gc = !0;
      }
      e = D();
  ...
  var qc;
  var rc = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?#]*)?\/u\/(\d)\//,
    sc = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?#]*)?\/b\/(\d{10,21})\//,
    tc = function(a) {
      ...
      null == b &&
        ...
        (b = J(a, "authuser") || null),
        null == b && (b = (b = a.match(rc)) ? b[1] : null));
    ...
    uc = function(a) {
      ...
      null == b &&
        (b = (a = (a || window.location.href).match(sc)) ? a[1] : null);
      if (null == b) return null;
      b = String(b);
      21 < b.length && (b = null);
      return b;
  ...
  var vc,
    ...
    W = function(a, b) {
      ...
      if ("undefined" !== d) {
        ...
        if (null == a) b[b.length] = "null";
          ...
          if (e === xc) return W(a.toISOString.call(a), c);
          if (e === Bc && V(a.length) === wc) {
            b[b.length] = "[";
            var f = 0;
            for (d = Number(a.length) >> 0; f < d; ++f)
              f && (b[b.length] = ","), (b[b.length] = W(a[f], c) || "null");
            b[b.length] = "]";
          } else if (e == zc && V(a.length) === wc) {
            b[b.length] = '"';
            f = 0;
    ...
    Wc = function(a) {
      if (-1 !== S) return Uc(), T ? m.JSON.stringify.call(m.JSON, a) : W(a);
    },
    Xc =
  ...
  $c.prototype.update = function(a, b) {
    if (null != a) {
      ...
      for (var c = b - this.j, d = 0, e = this.L, f = this.o; d < b; ) {
        if (0 == f) for (; d <= c; ) ad(this, a, d), (d += this.j);
        if ("string" === typeof a)
          for (; d < b; ) {
  ...
  var cd = A.crypto,
    ...
    jd = function(a) {
      ...
      gd = (gd * b) % hd;
      0 < ed && ++fd == ed && eb("mousemove", jd, "remove", "de");
    },
    kd = function(a) {
      var b = new bd();
  ...
  dd = !!cd && "function" == typeof cd.getRandomValues;
  dd ||
    ((hd = 1e6 * (screen.width * screen.width + screen.height)),
    (id = kd(
      B.cookie +
        "|" +
        B.location +
    ...
    (ed = Q("random/maxObserveMousemove") || 0),
    0 != ed && eb("mousemove", jd, "add", "at"));
  var ld = function() {
      var a = gd;
      a += parseInt(id.substr(0, 20), 16);
      id = kd(id);
      return a / (hd + Math.pow(16, 20));
    },
    md = function() {
      var a = new A.Uint32Array(1);
      cd.getRandomValues(a);
      return Number("0." + a[0]);
    };
  var nd = function() {
      var a = L.onl;
    ...
    od = function(a, b) {
      b = b.onload;
      return "function" === typeof b ? (nd().a(a, b), b) : null;
    },
    pd = function(a) {
  ...
  var rd = {
    ...
    sd = { allowtransparency: !0, onload: !0 },
    td = 0,
    ud = function(a) {
      H(!a || db.test(a), "Illegal url for new iframe - " + a);
    },
    vd = function(a, b, c, d, e) {
      ...
      try {
        document.all &&
          (f = a.createElement(
            '<iframe frameborder="' +
              Pa(String(c.frameborder)) +
              '" scrolling="' +
              Pa(String(c.scrolling)) +
              '" ' +
              h +
              ' name="' +
              Pa(String(c.name)) +
      ...
      for (var k in c)
        (a = c[k]),
          "style" === k && "object" === typeof a
            ? F(a, f.style)
            : sd[k] || f.setAttribute(k, String(a));
      (k = (e && e.beforeNode) || null) || (e && e.dontclear) || jb(b);
      b.insertBefore(f, k);
  ...
  var wd = /^:[\w]+$/,
    ...
    Ad = function(a) {
      return function(b, c) {
        return a ? yd()[c] || a[c] || "" : yd()[c] || "";
      };
    };
  var Bd = function(a) {
      var b;
      a.match(/^https?%3A/i) && (b = decodeURIComponent(a));
      return cb(document, b ? b : a);
    },
    Cd = function(a) {
      a = a || "canonical";
      for (
      ...
      for (f = 0; f < e.length; f++) {
        ...
        if (k.getAttribute("data-gapiscan")) h = null;
          ...
          0 == p
            ? (n = l.substr(2))
            : (p =
                (p = String(k.className || k.getAttribute("class"))) &&
                Sd.exec(p)) && (n = p[1]);
          h = !n || !(Od[n] || Pd[n] || X[n]) || (h && n !== h) ? null : n;
        }
        h &&
          (Td[h] ||
      ...
      switch (de(b, a, f)) {
        ...
        case 1:
          if (b.parentNode) {
            ...
            f = cb(B, e.replace(xd, zd));
            b = c.ownerDocument || B;
            k = 0;
            do e = h.id || ["I", td++, "_", new Date().getTime()].join("");
            ...
            r ||
              ((r = h.rpctoken || String(Math.round(1e8 * (dd ? md() : ld())))),
              (p.rpctoken = r));
            h.rpctoken = r;
            ...
            if (k.forcePost || (p && 2e3 < f.length)) {
              ...
              for (p = 0; p < l.length; p++)
                (r = l[p].split("=", 2)),
                  h.push([decodeURIComponent(r[0]), decodeURIComponent(r[1])]);
              k.query = [];
              l = Za(k);
              H(db.test(l), "Invalid URL: " + l);
              k = b.createElement("form");
              k.method = "POST";
              k.target = e;
              k.style.display = "none";
              e = l instanceof v ? l : za(l);
              pa(k, "HTMLFormElement").action = wa(e);
  ...
  xb.push([
    ...
    function(a, b, c) {
      ...
      b && Qd.push(b);
      fe(ae, a);
      fe(be, c._c.annotation);
      fe(ce, c._c.bimodal);
      ec();
      cc();
      if ("explicit" != Q("parsetags")) {
        mb(a);
        jc(ic()) && !Q("disableRealtimeCallback") && nc();
        if (c && (a = c.callback)) {
          var d = Ra(a);
          delete c.callback;
        }
  ...
  var he = /^\{h:'/,
    ...
    ke = function(a, b) {
      ...
      var c = !1;
      ie.test(a) && ((c = !0), (a = a.substr(2)));
      if (!/^\{/.test(a)) return !1;
      var d = Vc(a);
      if (!d) return !1;
      a = d.f;
      if (d.s && a && -1 != Ia.call(b, a)) {
        if ("_renderstart" === d.s || d.s === je + "/" + a + "::_renderstart")
          if (
            ((d = d.a && d.a[c ? 0 : 1]),
  ...
  me.prototype.write = function(a, b) {
    if (!oe.test(this.N)) throw "Invalid cookie name";
    if (!ne.test(a)) throw "Invalid cookie value";
    a = this.N + "=" + a;
  ...
  var pe = function(a) {
    ...
    Y = {};
  pe.prototype.read = function() {
    if (Y.hasOwnProperty(this.G)) return Y[this.G];
  };
  pe.prototype.write = function(a) {
    Y[this.G] = a;
    return !0;
  };
  ...
  pe.iterate = function(a) {
    for (var b in Y) Y.hasOwnProperty(b) && a(b, Y[b]);
  };
  var qe = "https:" === window.location.protocol,
    re = qe || "http:" === window.location.protocol ? me : pe,
    se = function(a) {
      var b = a.substr(1),
        c = "",
  ...
  var ue = function(a) {
      ...
      if (-1 == d) return b;
      var e = se(a.substr(d + 1));
      if (null == e) return b;
      a = a.substring(0, d);
      if ("_" !== a.charAt(0)) return b;
      d = "E" === c && e.i;
      return (!d && ("U" !== c || e.i)) || (d && !qe)
        ? b
        : { Z: !0, i: d, na: a.substr(1), domain: e.domain, l: e.l };
    },
    ve = function(a) {
      if (!a) return [];
      a = a.split("=");
    ...
    xe = function() {
      ...
      if (null !== a) {
        var c;
        re.iterate(function(f, g) {
          (f = ue(f)) && f.Z && f.i == b.i && f.l == b.l && (c = g);
        });
        if (c) {
          var d = we(c),
            e = d && d.ma[Number(a)];
          d = d && d.clientId;
          if (e) return { K: a, la: e, clientId: d };
        }
      }
      return null;
    };
  ...
  Z.prototype.aa = function() {
    this.M &&
      ...
      window.setTimeout(fa(this.aa, this), 1e3 * this.v));
  };
  for (var ze = 0; 64 > ze; ++ze);
  var Ae = null;
  mc = function() {
    return (L.oa = !0);
  };
  nc = function() {
    L.oa = !0;
    var a = xe();
    (a = a && a.K) && dc("googleapis.config/sessionIndex", a);
    Ae || (Ae = C(L, "ss", new Z()));
    a = Ae;
    a.ca && a.ca();
  };
    ...
    Xb("auth", {
      callback: function() {
        ...
        d.checkSessionState(e, function(f) {
          ...
          dc("savedUserState", g);
          (h || k) && jc(f) && !Q("disableRealtimeCallback") && d._pimf(f, !0);
        });
      }
    });
    return !0;
...
gapi.load("", {
  ...
  _c: {
    jsl: {
      ...
      h:
        "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en_GB.iWyQuFdbWzA.O/am\u003dwQc/d\u003d1/ct\u003dzgms/rs\u003dAGLTcCOyhlEmBby7qWoiftyYszJcOof1oQ/m\u003d__features__",
